...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../node_modules/lodash/isObject.js":[function(require,module,exports) {
/**
...
},{"./isObject":"../node_modules/lodash/isObject.js","./now":"../node_modules/lodash/now.js","./toNumber":"../node_modules/lodash/toNumber.js"}],"js/fetchCountries.js":[function(require,module,exports) {
"use strict";
...
},{}],"js/SawapAllerts.js":[function(require,module,exports) {
"use strict";
...
},{"sweetalert2":"../node_modules/sweetalert2/dist/sweetalert2.all.js"}],"js/Card.js":[function(require,module,exports) {
"use strict";
...
exports.card = card;
},{}],"js/onCheckedCountry.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.onCheckedCountry = void 0;

var _Card = require("./Card");

const onCheckedCountry = (e, element, listCountiest, elemets) => {
  ...
  (0, _Card.card)([findElement]);
};

exports.onCheckedCountry = onCheckedCountry;
},{"./Card":"js/Card.js"}],"js/ElementList.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.elementsList = void 0;

var _onCheckedCountry = require("./onCheckedCountry");

const elementsList = (elements, rootList) => {
  ...
  listCountiest.forEach(counry => counry.addEventListener('click', e => (0, _onCheckedCountry.onCheckedCountry)(e, counry, listCountiest, elements)));
};

exports.elementsList = elementsList;
},{"./onCheckedCountry":"js/onCheckedCountry.js"}],"js/CreateTable.js":[function(require,module,exports) {
"use strict";
...
var _SawapAllerts = require("./SawapAllerts");
...
const createTable = elements => {
  ...
  if (elements.length > 1 && elements.length < 10) {
    (0, _ElementList.elementsList)(elements, rootList);
  }

  if (elements.length > 10) {
    (0, _SawapAllerts.swalAlert)('Too many matches found. Please enter a more specific query!');
  }

  ;

  if (elements.length === 1) {
    (0, _Card.card)(elements);
  }
};

exports.createTable = createTable;
},{"./Card":"js/Card.js","./ElementList":"js/ElementList.js","./SawapAllerts":"js/SawapAllerts.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _SawapAllerts = require("./js/SawapAllerts");

var _CreateTable = require("./js/CreateTable");
...
const onInput = e => {
  ...
  (0, _fetchCountries.fetchCountries)(value).then(res => {
    rootLeft.innerHTML = '';
    rootRight.innerHTML = '';

    if (res.length > 0) {
      (0, _CreateTable.createTable)(res);
    }
  }).catch(err => {
    ...
    (0, _SawapAllerts.swalAlert)(err.message);
  });
};

inputRef.addEventListener('input', (0, _debounce.default)(onInput, 500));
console.log('well done');
},{"./sass/main.scss":"sass/main.scss","lodash/debounce":"../node_modules/lodash/debounce.js","./js/fetchCountries":"js/fetchCountries.js","./js/SawapAllerts":"js/SawapAllerts.js","./js/CreateTable":"js/CreateTable.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
